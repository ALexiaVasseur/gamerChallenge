  ...
  return (
    <div className="text-white p-8 min-h-screen flex items-center justify-center">
      <div className="bg-[#323030] p-8 rounded-lg shadow-lg max-w-2xl w-full text-center">
        <h2 className="text-3xl font-extrabold mb-6">🔒 Politique de Confidentialité</h2>
        ...
        <h3 className="text-xl font-bold text-yellow-400 mb-2">Collecte des données</h3>
        <p className="mb-4 text-gray-400">
          Nous collectons certaines informations lorsque vous utilisez notre plateforme : nom, email, préférences de jeux, etc. 🎮
        </p>

        <h3 className="text-xl font-bold text-yellow-400 mb-2">Utilisation des données</h3>
        <p className="mb-4 text-gray-400">
        ...
        <h3 className="text-xl font-bold text-yellow-400 mb-2">Partage des données</h3>
        <p className="mb-4 text-gray-400">
        ...
        <h3 className="text-xl font-bold text-yellow-400 mb-2">Vos droits</h3>
        <p className="mb-4 text-gray-400">
