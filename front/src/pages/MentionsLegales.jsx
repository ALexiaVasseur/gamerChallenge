  ...
  return (
    <div className="text-white p-4 sm:p-8 min-h-screen flex items-center justify-center">
      <div className="bg-[#323030] p-4 sm:p-8 rounded-lg shadow-lg max-w-4xl w-full text-center">
        <h2 className="text-2xl sm:text-3xl font-extrabold mb-6">📜 Mentions Légales</h2>

        <p className="mb-4 text-gray-300">
          Bienvenue sur <strong>GamerChallenge</strong>, une plateforme dédiée aux gamers passionnés ! 🚀
        </p>

        <h3 className="text-lg sm:text-xl font-bold text-yellow-400 mb-2">Éditeur du site</h3>
        ...
        <h3 className="text-lg sm:text-xl font-bold text-yellow-400 mb-2">Hébergement</h3>
        <p className="mb-4 text-gray-400">
          <strong>Hébergeur :</strong> ServerX Gaming Cloud<br />
          <strong>Adresse :</strong> 42 Rue des Serveurs, 75000 Paris, France
        </p>

        <h3 className="text-lg sm:text-xl font-bold text-yellow-400 mb-2">Propriété intellectuelle</h3>
        <p className="mb-4 text-gray-400">
